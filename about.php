				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="overview-wrapper">
						    <h3>We have an energetic, passionate and experienced team which works hard from Dawn till Dusk to provide the best in class service. </h3>
                            <p>
                                We are pleased to introduce ourselves as Neophilic Solutions founded in 2022. is one of the pioneer interior design contracting company in this profession / trade for more than the last 6 years. Neophilic Solutionsexecuted various major prestigious projects all over PAN India. The company&rsquo;s Executive Staff and Technical Experts have already handled a vast range of Projects including Multi storied buildings, Group housings of public sector, Schools, Hotels, Industrial and Commercial buildings etc.
                            </p>
                            <p>
							Quality and Safety is embedded in our company culture. Ultimately, our success in this business is measured after the completion of each project we undertake, there must remain a satisfied client - one who will ask us back for the next project and recommend us to others.
							</p>
						</div>
                    </div>
                    <!-- Start Column -->
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="overview-image">
                        	<img src="images/about-vd.jpg" alt="overview">
                        </div>
				    </div>
				    <!-- End Column -->
				</div>
